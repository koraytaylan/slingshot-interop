...
// Containers deliberately left behind for the leak-check case, removed in
// afterAll once that case has proven the leak check sees them.
...
describe("container lifecycle", () => {
	test(
		...
		async () => {
			...
			const captured = await started.captureLogs();
